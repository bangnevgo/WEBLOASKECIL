...
export const translations = {
  id: {
    ...
    faq_q3: 'Apa perbedaan antara materi gratis di sini dan program berbayar Nevgo Institute?',
    faq_a3: 'Materi di sini adalah modul edukasi terbuka 100% Free. Jika Anda butuh sistem latihan 21 drill harian di platform LMS interaktif atau bimbingan langsung tatap muka via Zoom bersama Bang Nevgo, Anda dapat mengambil Bootcamp Mandiri atau Kelas Interaktif di Nevgo Institute.',
    ...
    faq_q5: 'Apakah seluruh materi kurikulum ini benar-benar gratis?',
    faq_a5: 'Ya, 100% gratis tanpa biaya tersembunyi. Seluruh 10 bagian dan 49 pelajaran dapat diakses penuh setelah Anda mendaftar akun gratis.',
  ...
  en: {
    ...
    faq_q3: 'What is the difference between this free material and paid programs at Nevgo Institute?',
    faq_a3: 'The material here is an open, 100% free educational module. If you need a structured 21-day LMS practice drill or direct live Zoom group mentoring with Bang Nevgo, you can join the Self-Paced Bootcamp or Interactive Live Class at Nevgo Institute.',
    ...
    faq_q5: 'Is this curriculum truly 100% free?',
    faq_a5: 'Yes, 100% free with no hidden fees. All 10 parts and 49 lessons are fully accessible upon registering your free account.',
