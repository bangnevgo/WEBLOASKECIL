    ...
    return (
      <div className="nv-page" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
        <div style={{ textAlign: 'center' }}>
          <p style={{ color: 'var(--nv-muted)' }}>Lesson not found</p>
          <button className="nv-back-btn" onClick={closeLesson} style={{ marginTop: 16 }}>← Back to Dashboard</button>
        </div>
      </div>
    )
  }
          ...
          >
            ...
            {lesson.quotes.map((q, i) => (
              ...
              >
                ...
                <p className="nv-lesson-quote-source">— {q.source}</p>
                <a
                ...
                >
                  Read full text at CoolWisdomBooks →
                </a>
              </motion.div>
            ))}
          </motion.div>
          ...
          <div className="nv-lesson-nav">
            {prevLesson && prevPart ? (
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
              >
                <span style={{ fontSize: 12, color: 'var(--nv-dim)' }}>← Previous</span>
            ...
            {nextLesson && nextPart ? (
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
              >
                <span style={{ fontSize: 12, color: 'var(--nv-dim)' }}>Next →</span>
